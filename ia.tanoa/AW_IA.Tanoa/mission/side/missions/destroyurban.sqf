...
//-------------------- SPAWN GUARDS and CIVILIANS
	//was 5
	[[currentSM],[6,1],[7,1],[0,0],[0],[0],[0,0],[5,1,1200,EAST,FALSE,FALSE]] call EOS_Spawn; //insurgent
	sleep 1;
...
//-------------------- BRIEFING
	...
	["NewSideMission", "Destroy Weapons Shipment"] remoteExec ["AW_fnc_globalNotification",0,false];
...
//--------------------- DELETE, DESPAWN, HIDE and RESET
	...
	SM_SUCCESS = false;											// reset var for next cycle
